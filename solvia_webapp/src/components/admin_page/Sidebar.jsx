    ...
    <>
      ...
      >
        ...
        <div className="sidebar-menu">
          ...
          <button
            className={
              location.pathname === "/admin/farmer_flood_report" ? "active" : ""
            }
            onClick={() => navigate("/admin/farmer_flood_report")}
          >
          ...
          <button
            className={
              location.pathname === "/admin/farmer_registry" ? "active" : ""
            }
            onClick={() => navigate("/admin/farmer_registry")}
          >
          ...
          <button
            className={
              location.pathname === "/admin/manage_typhoon"
                ? "active"
                : ""
            }
            onClick={() => navigate("/admin/manage_typhoon")}
          >
            <span className="menu-icon"><FaWind /></span>
            {!isCollapsed && "Manage Typhoon"}
          </button>

          <button
            className={
              location.pathname === "/admin/account_management"
                ? "active"
                : ""
            }
            onClick={() => navigate("/admin/account_management")}
          >
